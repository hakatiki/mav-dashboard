...
class DelayAwareRouteMap:
    ...
    def create_delay_map(self, routes, enriched_segments):
        """Create the base map for delay visualization"""
...
def generate_delay_map_html(all_json_content, route_data_dir="data/all_rail_data"):
    """
    ...
    """
    visualizer = DelayAwareRouteMap(route_data_dir, all_json_content)
